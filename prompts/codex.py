...
def generate_codex_prompt(codex_prompt: str) -> str:
    ...
    output += f"{codex_prompt}\n"
    output += "Please write a codex entry that fulfill this need, fits the general theme and vibe of the world so far, and doesn't contradict any of the existing codex entries I have provided you here.\n"
    output += "Thank you."
    return output
