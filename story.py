...
current_story = Story(
    ...
    setting_notes="""This is essentially "Hitchhiker's Guide to the Galaxy", but set in Planescape or Spelljammer. The planes are real. Magic is real. The vastness of the cosmos is overwhelming. Humanity isn't invited, but they sure do make good passengers.
