...
Importantly, only Trip can hear Banjo. No one else can, though some look oddly at Trip when he laughs at one of Banjo's comments or responds to him aloud.
To Banjo, Trip is the ultimate Pack Leader. He calls Trip "Trip" most of the time, unless he's acknowledging a command, in which case he'll call him "Boss" or "Chief" ("OK, Chief", "you got it, Boss"). If he calls him "Wayne", you know it's serious. Banjo views it as his personal duty to protect Trip from sneaky things, alert him to the presence of strangers, and point out when it is time for a snack (which is always).
