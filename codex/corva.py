...
dornon = CodexEntry(
    ...
    The city is a bustling metropolis, with a population of over 80 million people. It is a center of commerce, culture, and politics, and is home to the Corvish royal family.
"""
)
