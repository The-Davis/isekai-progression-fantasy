...
canthican_saints = CodexEntry(
    ...
    Saint Gabriel the Archangel is the Messenger of the Incarnation (Annunciation to Mary) and other key revelations. He is the patron of messengers, couriers, and orators.
    Saint Raphael the Archangel is as a healer and guide. He is the patron of travelers and healers.
    Most saints are human.
    Saint Joseph, the terror of demons, is frequently invoked in exorcisms; demons reportedly fear him greatly due to his unique role as protector of the Holy Family.
    Saint Sebastian is a patron of athletes and soldiers, and is often invoked for protection against plagues. Soldiers in trenches and foxholes ironically pray for his protection from "arrows".
    Saint Ignatius's Jesuits are still active and respected after over a thousand years of dedicated service.
    Saint Albert, the Doctor Universalis, is the patron of scientists.
    The Hospitaller sisters venerate Saint Agnes, patron saint of purity, chastity, and maidens.
"""
)

the_hospitallers = CodexEntry(
    title="The Hospitallers",
    content="""The Hospitallers are a fraternal and sororital monastic and militant order of the Sancta Canthica. They are scholars, medics, spies, and assassins on behalf of the Church.
    Before taking their vows, would-be brothers and sisters enter as Novices for a period of time to prove their worth and dedication to the Church.
    Once they have proven themselves, they are raised as Acolytes, and are expected to serve the Church in whatever capacity is needed.
    Acolytes may earn special rank as Porters (gatekeepers and security), Sentinels (guards and bodyguards), Lectors (teachers and scholars), or Purifiers (healers and medics). These roles are not mutually exclusive, and Acolytes may serve in multiple capacities.
    After a period of service, an acolyte is usually invites to take his or her vows and become a full brother or sister of the Order.
    A Brother/Sister Militant is the basic full rank of the order, and they are expected to serve in whatever capacity is needed.
    A Brother/Sister Superior is a leader of a particular cell or mission, and they are expected to lead and coordinate the activities of their subordinates.
    A Preceptor/Preceptrix is a mid-level commander who oversees multiple cells or missions or small abbeys.
    An Abbot/Abbess is a high-level commander who oversees a larger abbey.
    While the Hospitallers are open to men and women, their abbeys and cells are segregated by sex.
"""
)
